        ...
        : PlainLineEdit(parent), cat(prop->getPartCategory()), prop(prop), state(Enabled), flags(0)
{
    ...
    connect(this, &PropertyLineEdit::textChanged, this, &PropertyLineEdit::textEditedSlot);
...
QVariant PropertyLineEdit::getValue() const
{
...
void PropertyLineEdit::textEditedSlot(const QString& text)
{
    try {
